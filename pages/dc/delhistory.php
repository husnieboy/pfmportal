                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div>
									<table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-hover"  id="HelpdeskOverview">
									...
									<thead>
										...
										<th class="list-group-item-info">Scan Ticket</th>
