...
<table cellpadding="0" cellspacing="0" border="1" style="border-style: solid;border-color:#e5e5e5;" class="table"  id="">
					...
					<thead>
						...
						<td align="right">
						<p><b>TRIP TICKET SUMMARY REPORT</b></p><?php if($iuser=="dc"){?><form method="POST" action="../export/exportrange.php"><input type="hidden" name="dn" value="<?php echo $iuser; ?>" /><input id="buttonex" type="submit" value="Export"/></form><?php }else{} ?><font size="1"><p><?php echo date("m/d/Y H:s"); echo 'H'; ?></p></font>
						</td>
						</tr>
						</table>
						</th>
