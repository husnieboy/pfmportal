...
<div>
				...
				<input ng-pattern="/^[0-9]+(\.[0-9]{1,2})?$/" type="text" id="ansino" name="ansino[]" placeholder="ANSI" required/>
				</td>
				</tr>
				<td>
				...
				<tr><td>	
				<input type="button" class="add_field_button" value="+">
				</td></tr>
...
$sql = "INSERT INTO dbo.tpoapp (ap_pono,ap_stno,ap_refno,ap_terms,ap_deldate) VALUES ('" . $ansino[$i] . "','" . $store[$i] . "','" . $jdapo[$i] . "','7','$deldate')";

 $r = odbc_exec ($cs ,$sql) or die ( 'Query Error' );
 
echo 'FF Inserted'; echo'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'; echo $store[$i]; echo'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'; echo $jdapo[$i]; echo'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'; echo $ansino[$i]; echo'<br><br>';
}	
		}
//}
//}
