        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-8">
					...
					<div class="controls">
						<input name="user_password" class="form-control" type="password" value="<?php echo $row['user_password'] ?>" required />
					</div>
					</div>
					...
					<div class="controls">
						<input name="store_name" class="form-control" type="text" value="<?php echo $row['store_name'] ?>" />
					</div>
					</div>
