...
<form id="add" class="form-horizontal" method="post" action="tags_check.php"> 
					...
					<input name="bar_purple" id="bar_purple" type="Hidden" Value="PURPLE" required/>
...
<table cellpadding="0" cellspacing="0" border="0" class="table-striped table-bordered alert-purple" width="80%">
<tr class="tableheader">
<td><div class="alert alert-success2"><label align="center">Purple</label></div></td>
</tr>
<td align="center">
...
$result = mysqli_query($link,"SELECT * FROM pfmtagsreq WHERE Store_Tags_Name='$name' And Date_Time='$datatagstoday' And stclr='Purple'");
