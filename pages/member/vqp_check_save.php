...
if($data[0] < 1)
{
  ...
  mysqli_query($link,"INSERT INTO vqpusers (vqp_code,vqp_password,vqp_name,vqp_store,vqp_position,vqp_status,vqp_date,ams_store) values('$vqp_code','$vqp_password','$vqp_name','$vqp_store','$vqp_position','$vqp_status','$vqp_date','$vqp_am')")or die(mysqli_error());
