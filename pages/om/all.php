...
\
					...
					<tbody>
						...
						$query=mysqli_query($link,"SELECT * FROM pfmsales Where pfmsales.Area_Store='$id' ORDER BY Time ASC")or die(mysqli_error());
					...
					<a class="btn btn-success" href="area.php<?php echo '?area='.$_GET['area']; ?>">Return</a>