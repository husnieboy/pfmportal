...
$sql = "SELECT tempid,branch,repdate,code,pd_desc,SUM(TOTQTY),SUM(TOTAMT) FROM $DB_TBLName WHERE code IN('100032'
,'100033'
,'100034'
,'100035'
,'100036'
...
,'100052'
,'903623'
,'904450') AND repdate BETWEEN '$fdate' AND '$ldate' GROUP BY code,branch,repdate ";
