...
$sql = "SELECT Sales_ID,Total_Sales,TC,AC,CVS,FF,RTE,Waste,FillRate,ManHours,Store_Name,TransDate,Process_Week,Process_Month,Remarks FROM $DB_TBLName WHERE (Am_Name='$name' AND TransDate BETWEEN '$fdate' AND '$ldate') OR (Store_Name='$name' AND TransDate BETWEEN '$fdate' AND '$ldate')";
