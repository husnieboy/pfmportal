...
textarea {
	...
	<center>
			...
			<form class="form-horizontal" method="POST">
				...
				<input name="qc" id="qc" type="Hidden" placeholder="" value="QC"/>
			...
			$check= mysqli_query($link,"SELECT * FROM pfmsales WHERE TransDate='$tdate' AND Store_Name='$store_name'");
			...
			?>
				<script type="text/javascript">
					...
					window.alert("Sales Date Already Exist!!");
