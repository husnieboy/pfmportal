...
<body onload=displayTime();>
	...
	<center>
			...
			<div id="header">
				...
				<div class="alert alert-success" style="width:80%"><label>Welcome <?php echo $name ?></label></div>
...
<a id="sl" class="btn btn-green" href="sales.php">SALES DETAILS FORM</a>
<div class="alert alert-success" style="width:80%"><label>Scan BarCode for Request</label></div>
...
<table cellpadding="0" cellspacing="0" border="0" class="table-striped table-bordered alert-green" width="80%">
<tr class="tableheader">
<td><div class="alert alert-success2"><label align="center">Green</label></div></td>
</tr>
<td align="center">
